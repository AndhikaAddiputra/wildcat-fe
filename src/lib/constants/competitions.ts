...
export const COMPETITIONS: Competition[] = [
  {
    ...
    timeline: [
      ...
      { label: "Normal Registration", date: "23 March - 5 April 2026" },
      { label: "Abstract Submission", date: "12 April 2026" },
      { label: "Finalist Announcement", date: "28 April 2026" },
      { label: "Final Technical Meeting I", date: "2 May 2026" },
      { label: "Full Paper & Poster Submission", date: "28 May 2026" },
      { label: "Final Technical Meeting II", date: "12 June 2026" },
      { label: "Final Pitching Day", date: "20 June 2026" },
      { label: "Awarding Night", date: "21 June 2026" },
    ],
    imageUrl: "/PaPos.png",
  },
  {
    ...
    timeline: [
      { label: "Early Registration", date: "14 - 22 March 2026" },
      { label: "Normal Registration", date: "23 March - 5 April 2026" },
      { label: "Preliminary Case Release", date: "13 April 2026" },
      { label: "Preliminary Case Submission", date: "4 May 2026" },
  ...
  },
  {
    ...
    timeline: [
      ...
      { label: "Finalist Announcement", date: "16 May 2026" },
  ...
  },
  {
    ...
    timeline: [
      { label: "Early Registration", date: "13 - 22 March 2026" },
      { label: "Normal Registration", date: "23 March - 5 April 2026" },
      { label: "Technical Meeting I", date: "18 April 2026" },
      { label: "Essay Submission", date: "20 May 2026" },
      { label: "Finalist Announcement", date: "6 June 2026" },
      { label: "Technical Meeting II", date: "13 June 2026" },
      { label: "Final Competition Day", date: "20 June 2026" },
    ],
    imageUrl: "/Essay.png",
  },
];
